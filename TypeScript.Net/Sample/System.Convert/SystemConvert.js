...
require(["System/Convert"], function () {
    QUnit.module('System.Convert');
    test("ToInt32(value: string): number;", function () {
        ok(System.Convert.ToInt32("123") == 123, "Convertido '123' para int32.");
    });

    test("ToBoolean(value: string): boolean;", function () {
    ...
    test("ToDecimal(value: string): number;", function () {
...
//# sourceMappingURL=SystemConvert.js.map
