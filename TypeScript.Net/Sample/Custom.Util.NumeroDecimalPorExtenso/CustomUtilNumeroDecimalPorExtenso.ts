...
function Numero_Change(obj) {
    require(["System/Collections/Generic/Dictionary", "System/MathTs", "System/Convert", "System/Text/StringBuilder"
        , "Custom/String", "Custom/Util/NumeroPorExtenso", "Custom/Util/NumeroDecimalPorExtenso"], () => {
            var x: Custom.Util.NumeroDecimalPorExtenso = new Custom.Util.NumeroDecimalPorExtenso();
